...
public class NeedBracesCheckTest extends BaseCheckTestSupport {
    ...
    public void testSingleLineExitCase() throws Exception {
        ...
        final String[] expected = {
            "18: " + getCheckMessage(MSG_KEY_NEED_BRACES, "if"),
            "25: " + getCheckMessage(MSG_KEY_NEED_BRACES, "if"),
            "26: " + getCheckMessage(MSG_KEY_NEED_BRACES, "if"),
            "34: " + getCheckMessage(MSG_KEY_NEED_BRACES, "if"),
            "40: " + getCheckMessage(MSG_KEY_NEED_BRACES, "if"),
            "48: " + getCheckMessage(MSG_KEY_NEED_BRACES, "if"),
            "58: " + getCheckMessage(MSG_KEY_NEED_BRACES, "if"),
            "62: " + getCheckMessage(MSG_KEY_NEED_BRACES, "if"),
            "63: " + getCheckMessage(MSG_KEY_NEED_BRACES, "if"),
            "68: " + getCheckMessage(MSG_KEY_NEED_BRACES, "if"),
            "72: " + getCheckMessage(MSG_KEY_NEED_BRACES, "if"),
            "73: " + getCheckMessage(MSG_KEY_NEED_BRACES, "if"),
            "83: " + getCheckMessage(MSG_KEY_NEED_BRACES, "else"),
            "88: " + getCheckMessage(MSG_KEY_NEED_BRACES, "else"),
            "101: " + getCheckMessage(MSG_KEY_NEED_BRACES, "else"),
            "106: " + getCheckMessage(MSG_KEY_NEED_BRACES, "else"),
            "112: " + getCheckMessage(MSG_KEY_NEED_BRACES, "else"),
            "125: " + getCheckMessage(MSG_KEY_NEED_BRACES, "else"),
            "135: " + getCheckMessage(MSG_KEY_NEED_BRACES, "for"),
            "141: " + getCheckMessage(MSG_KEY_NEED_BRACES, "while"),
            "147: " + getCheckMessage(MSG_KEY_NEED_BRACES, "do"),
        };
